...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['phantram'])) {
    $km = new KhuyenMai();
    $themkhuyemai = $km->themKhuyenMai($_POST);
}
?>
<main class="p-6 sm:p-10 space-y-6">
    <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
        <div class="mr-6">
            <h1 class="text-4xl font-semibold mb-2">Thêm khuyến mãi</h1>
        </div>
    </div>
    <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" id="myForm" runat="server" class="p-6 bg-white shadow rounded-lg" style="background-color: #fff">
        ...
        <div class="mb-6">
            ...
            <input required name="phantram" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="">
        </div>
        <div class="mb-6">
            <label for="thoigian_bd" class="block mb-2 text-sm font-medium text-gray-900 ">Thời gian bắt đầu</label>
            <input type="date" name="thoigian_bd" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
        </div>
        <div class="mb-6">
            <div class="flex items-center peer">
                <input name='them_thoigian_kt' id="checked-checkbox" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600  focus:ring-2 dark:bg-gray-700 ">
            ...
            <div class="peer-has-[:checked]:block hidden">
                ...
                <input type="date" name="thoigian_kt" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
            </div>
        </div>
...
<div id="modal-option" class="hidden fixed inset-0 transition z-[200]">
    ...
    <div id="container__search" class="bg-gray-600 bg-opacity-40 relative h-full w-full ml-auto z-[201] p-2 flex justify-center items-center">
        <div class="container mx-auto">
            <h3 class="text-gray-800 md:text-md text-base font-seimbold">Thêm sản phẩm áp dụng khuyến mãi</h3>
...
<div id="modal_nofi" class="<?php echo isset($themkhuyemai) ? "" : "hidden" ?> relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400"><?php if (isset($themkhuyemai)) {
                                                                                                if ($themkhuyemai) {
