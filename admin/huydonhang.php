...
$dsdh = $dh->layDonHang(4, $p, $sapxep, $timKiem);
...
<main class="p-6 sm:p-10 space-y-6">
    ...
    <nav class="    ">
        <ul class="flex justify-end items-center -space-x-px h-10 text-base">
            ...
            <?php if ($p <= 1) : ?>
                <li>
                    <a href="huydonhang.php?p=<?php echo $prevP ?><?php echo $timKiem ? "&tk=$timKiem" : "" ?><?php echo $sapxep ? "&sx=$sapxep" : "" ?>" class="pointer-events-none opacity-40  hover:text-white hover:bg-blue-500 flex items-center justify-center px-4 h-10 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg ">
            ...
            <?php else : ?>
                <li>
                    <a href="huydonhang.php?p=<?php echo $prevP ?><?php echo $timKiem ? "&tk=$timKiem" : "" ?><?php echo $sapxep ? "&sx=$sapxep" : "" ?>" class="hover:text-white hover:bg-blue-500 flex items-center justify-center px-4 h-10 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg ">
                        <span class="sr-only">Previous</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1 1 5l4 4"></path>
                        </svg>
            ...
            <ul class="sm:inline-flex hidden">
                ...
                while ($i <= $tongTrang) {
                    if ((int)$p >= 3) {
                        if ($i < 3) { ?>
                            <li>
                                <a href="huydonhang.php?p=<?php echo $i ?><?php echo $timKiem ? "&tk=$timKiem" : "" ?><?php echo $sapxep ? "&sx=$sapxep" : "" ?>" class="<?php echo (int)$p == $i ? "text-white bg-blue-500" : "text-gray-900 bg-white hover:text-white hover:bg-blue-500" ?> flex items-center justify-center px-4 h-10 leading-tight border border-gray-300 "><?php echo $i ?></a>
                            </li>
                            <?php $i++;
                        } else {
                            if ($i < (int)$p) {
            ...
            <?php if ($p >= $tongTrang) : ?>
                <li>
                    <a href="huydonhang.php?p=<?php echo $nextP ?><?php echo $timKiem ? "&tk=$timKiem" : "" ?><?php echo $sapxep ? "&sx=$sapxep" : "" ?>" class="pointer-events-none opacity-40 hover:text-white hover:bg-blue-500 flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg  ">
            ...
            <?php else : ?>
                <li>
                    <a href="huydonhang.php?p=<?php echo $nextP ?><?php echo $timKiem ? "&tk=$timKiem" : "" ?><?php echo $sapxep ? "&sx=$sapxep" : "" ?>" class="hover:text-white hover:bg-blue-500 flex items-center justify-center px-4 h-10 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg ">
                        <span class="sr-only">Next</span>
                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path>
                        </svg>
